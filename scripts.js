...
amount.oninput = () => {
  ...
  // Transforma o valor em centavos( Ex: 150/100 1.5 = R$ 1,50).
...
function formatCurrencyBRL(value){
  // Formata o valor no padrão BRL ( padrao brasileiro)
...
function updateTotals() {
  try {
    ...
    // Formata o valor e remove o R$ que será exibido pela small com um estilo custom.
